// <copyright file="BlueColorScene.cs" company="KinsonDigital">
...
namespace ParticleEngineTester.Scenes
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueColorScene"/> class.
        /// </summary>
        ...
        public BlueColorScene(IRenderer renderer, IContentLoader contentLoader, string name)
