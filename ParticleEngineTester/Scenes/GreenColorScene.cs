// <copyright file="GreenColorScene.cs" company="KinsonDigital">
...
namespace ParticleEngineTester.Scenes
{
    ...
    /// <summary>
    /// Shows particles with Green color component for the purpose of testing.
    /// </summary>
    public class GreenColorScene : ParticleEngineSceneBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GreenColorScene"/> class.
        /// </summary>
        ...
        public GreenColorScene(IRenderer renderer, IContentLoader contentLoader, string name)
