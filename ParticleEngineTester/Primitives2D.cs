// <copyright file="Primitives2D.cs" company="KinsonDigital">
...
namespace ParticleEngineTester
{
    ...
    /// <summary>
    /// Extension methods that proved the ability to draw primitive 2D shapes.
    /// </summary>
    ...
    public static class Primitives2D
    {
        ...
        #region PutPixel
        /// <summary>
        /// Sets the color of the pixel at the given <paramref name="position"/> to the given <paramref name="color"/>.
        /// </summary>
        /// <param name="spriteBatch">The <see cref="SpriteBatch"/> type to extend.</param>
